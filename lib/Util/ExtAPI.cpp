...
static const ei_pair ei_pairs[]=
{
    ...
    {"ngx_pmemalign", ExtAPI::EFT_ALLOC},
    {"ngx_pcalloc", ExtAPI::EFT_ALLOC},
    {"ngx_array_init", ExtAPI::EFT_ALLOC},
    {"ngx_array_create", ExtAPI::EFT_ALLOC},
    {"ngx_list_init", ExtAPI::EFT_ALLOC},
    {"ngx_hash_init", ExtAPI::EFT_ALLOC},
    {"ngx_hash_keys_array_init", ExtAPI::EFT_ALLOC},
